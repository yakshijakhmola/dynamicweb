                    ...
                    <div className="xl:col-span-7 md:col-span-12 col-span-12" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
                        <div>
                            ...
                            <div className='grid grid-cols-12 mt-10' >
                                <div className='col-span-6 mb-5 xl:mb-0 xl:col-span-2 flex items-center justify-center flex-col' data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
                                    <img src="./ip65.svg" alt="IP65 24/7 use" className='w-12 mb-3'/>
                                    <p className='text-center'>IP65 24/7 use</p>
                                </div>
                                <div className='col-span-6 mb-5 xl:mb-0 xl:col-span-2 flex items-center justify-center flex-col' data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                                    <img src="./working-time.svg" alt="IP65 24/7 use" className='w-12 mb-3'/>
                                    <p className='text-center'>10 hours long working time</p>
                                </div>
                                <div className='col-span-6 mb-5 xl:mb-0 xl:col-span-2 flex items-center justify-center flex-col' data-aos="fade-right" data-aos-delay="300" data-aos-duration="1000">
                                    <img src="./brightness.svg" alt="IP65 24/7 use" className='w-12 mb-3'/>
                                    <p className='text-center'>2500 Nits high brightness</p>
                                </div>
                                <div className='col-span-6 mb-5 xl:mb-0 xl:col-span-2 flex items-center justify-center flex-col' data-aos="fade-right" data-aos-delay="400" data-aos-duration="1000">
                                    <img src="./protection.svg" alt="IP65 24/7 use" className='w-12 mb-3'/>
                                    <p className='text-center'>Front Protection</p>
                                </div>
                                <div className='col-span-6 mb-5 xl:mb-0 xl:col-span-2 flex items-center justify-center flex-col' data-aos="fade-right" data-aos-delay="500" data-aos-duration="1000">
